<?php
    ...
    $HTML = build_md_html_table('sourcedesc_biblstruct_analytic_author', 'Author', array('Type', 'Name', 'Key'));
    // Generate global variable and event-binding
    $JS   = build_md_global_variable_script('sourcedesc_biblstruct_analytic_author', 'author_id', $date_format, $result, $options);
    $JS  .= build_md_event_script('sourcedesc_biblstruct_analytic_author', '{{ module_site_url }}manage_imbrex_filedesc/index/insert', '{{ module_site_url }}manage_imbrex_filedesc/index/update');
    // Show HTML
    echo $HTML;
    // Show JS
...
<script type="text/javascript">
    ...
    function default_row_sourcedesc_biblstruct_analytic_author(){
        return {
            type : '',
            name : '',
            key : '',
    ...
    // Function to add row
    function add_table_row_sourcedesc_biblstruct_analytic_author(value){

        // Prepare some variables
        var input_prefix = 'md_field_sourcedesc_biblstruct_analytic_author_col';
        var row_index    = RECORD_INDEX_sourcedesc_biblstruct_analytic_author;
        ...
        html += build_single_select_option(field_value, OPTIONS_sourcedesc_biblstruct_analytic_author.type);
        html += '</select>';
        inputs.push(html);
