...
<div>
	<?php
	if($sresult){
		foreach($sresult as $record){
		if($record->title){echo '<h2 class="text-center">'.$record->title.'</h2>';}
		} 
	}
	?>
</div>
...
<script type="text/javascript">
    var PAGE                   = 1;
    var URL                    = '<?php echo site_url($module_path."/browse_imbrex_filedesc/get_data"); ?>';
    ...
    function fetch_more_data(async){
        ...
        $('#record_content_bottom').html('Load more Edition &nbsp;<img src="{{ BASE_URL }}assets/nocms/images/ajax-loader.gif" />');
        ...
        REQUEST = $.ajax({
            ...
            'success'  : function(response){
                ...
                var bottom_content = 'No more Edition to show.';
                if(ALLOW_NAVIGATE_BACKEND && HAVE_ADD_PRIVILEGE){
