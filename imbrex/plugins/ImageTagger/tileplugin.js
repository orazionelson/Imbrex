...
(function ($) {
	...
	*/
	var _Itag = function (args) { 
		...
		if(TILE.experimental) {
			...
			self.htmlToolbar = "<div class=\"panel-heading\"><span>Image Tagger</span> "+
			"<span class=\"menuitem\">"+
			"<a href=\"#\" id=\"pointer\" class=\"btn btn-default btn-sm btnIconLarge inactive\" title=\"Select\"><span class=\"glyphicon glyphicon-hand-up\" aria-hidden=\"true\"></span></a></span>"+
			"<span class=\"menuitem\">"+
			"<a href=\"#\" id=\"rect\" class=\"btn btn-default btn-sm btnIconLarge inactive\" title=\"Rectangle\"><span class=\"glyphicon glyphicon-new-window\" aria-hidden=\"true\"></span></a>"+
			"<a href=\"#\" id=\"elli\" class=\"btn btn-default btn-sm btnIconLarge inactive\"  title=\"Ellipse\"><span class=\"glyphicon glyphicon-record\" aria-hidden=\"true\"></span></a>"+
			"</span><span class=\"menuitem\"><a href=\"#\" id=\"zoomIn\" class=\"btn btn-default btn-sm btnIconLarge\" title=\"Zoom In\"><span class=\"glyphicon glyphicon glyphicon-zoom-in\" aria-hidden=\"true\"></span></a>"+
			"<a href=\"#\" id=\"zoomOut\" class=\"btn btn-default btn-sm btnIconLarge\" title=\"Zoom Out\"><span class=\"glyphicon glyphicon glyphicon-zoom-out\" aria-hidden=\"true\"></span></a></span><!--span class=\"menuitem\">"+
			"<a href=\"#\" id=\"pgPrev\" class=\"button\" title=\"Go One Image Back\">Prev</a><a href=\"#\" id=\"pgNext\" class=\"button\" title=\"Go One Image Forward\">Next</a>"+
			"<a class=\"button\" title=\"See a List of All Images\"><span id=\"listView\" class=\"listView\"><span class=\"glyphicon glyphicon-th-list\" aria-hidden=\"true\"></span></span></a></span--></div>";
	...
	**/
	...
	var RaphaelImage=function(args){
		...
		this.shapeIds=[];
		//this._loadPage=$("<div class=\"loadPage\" style=\"width:100%;height:100%;\"><img src=\"assets/styles/images/cube.gif\"/></div>");
		//global listeners
	...
	//console.log(TILE.scale+"-"+self._imgScale+'-'+this.height+'-'+oh);
				...
				//$(".vd-container").css('height',$('#az_log').height());
		...
		setActiveShape:function(shpObj){
			...
			$("<div class=\"shpButtonHolder\"><div id=\""+shpObj.id+"\" class=\"button shape\"><button class=\"btn btn-info btn-xs\">Delete <span class=\"glyphicon glyphicon-remove\" aria-hidden=\"true\" title=\"Delete\"></span></button></div></div>").insertBefore($("svg"));//
