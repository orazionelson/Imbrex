	...
	var Trans={
		...
		*/
		start:function(mode){
			...
			var html='<div id="tile_toolbar" class="toolbar panel-heading"><span>Transcript Lines </span></div><div id="logbar_list" class="az panel-body"></div>';
			TILE.engine.insertModeHTML(html,'topleft',mode.name);
			// insert button
			TILE.engine.insertModeButtons('<span class="menuitem"><ul><li><a id="L579" class="btnIconLarge getTrans btn btn-default btn-sm" title="Activate Transcript Mode"><span class="glyphicon glyphicon-text-width" aria-hidden="true"></span></a></li></ul></span>','topleft',mode.name);
