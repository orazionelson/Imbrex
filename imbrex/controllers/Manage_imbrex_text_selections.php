...
/**
 * Description of Manage_imbrex_text_selections
 *
 * @author No-CMS Module Generator
 */
class Manage_imbrex_text_selections extends CMS_CRUD_Controller {

    protected $URL_MAP = array();
    protected $TABLE_NAME = 'imbrex_text_selections';
    protected $COLUMN_NAMES = array('page_id', 'id', 'startparent', 'startoffset', 'startchild', 'endparent', 'endoffset', 'endchild', 'color', 'labels');
    protected $PRIMARY_KEY = 'selection_id';
    ...
    protected function make_crud(){
        ...
        // set subject
        $crud->set_subject('Selections');

         // displayed columns on list, edit, and add, uncomment to use
        //$crud->columns('page_id', 'id', 'startparent', 'startoffset', 'startchild', 'endparent', 'endoffset', 'endchild', 'color');
        //$crud->edit_fields('page_id', 'id', 'startparent', 'startoffset', 'startchild', 'endparent', 'endoffset', 'endchild', 'color', '_updated_by', '_updated_at');
        //$crud->add_fields('page_id', 'id', 'startparent', 'startoffset', 'startchild', 'endparent', 'endoffset', 'endchild', 'color', '_created_by', '_created_at');
        //$crud->set_read_fields('page_id', 'id', 'startparent', 'startoffset', 'startchild', 'endparent', 'endoffset', 'endchild', 'color');

        // caption of each columns
        $crud->display_as('page_id','Page id');
        $crud->display_as('id','json id');
        $crud->display_as('startparent','StartParent');
        $crud->display_as('startoffset','StartOffset');
        $crud->display_as('startchild','StartChild');
        $crud->display_as('endparent','EndParent');
        $crud->display_as('endoffset','EndOffset');
        $crud->display_as('endchild','EndChild');
    ...
    public function index(){
        ...
        // show the view
        $this->view($this->cms_module_path().'/Manage_imbrex_text_selections_view', $output,
            $this->n('manage_imbrex_text_selections'), $config);
    }
