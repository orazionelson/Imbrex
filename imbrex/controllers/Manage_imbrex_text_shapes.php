...
/**
 * Description of Manage_imbrex_text_shapes
 *
 * @author No-CMS Module Generator
 */
class Manage_imbrex_text_shapes extends CMS_CRUD_Controller {

    protected $URL_MAP = array();
    protected $TABLE_NAME = 'imbrex_text_shapes';
    protected $COLUMN_NAMES = array('page_id', 'id', 'type', '_scale', 'color', 'posinfo_x_cx', 'posinfo_y_cy', 'posinfo_width_rx', 'posinfo_height_ry', 'labels', 'lines');
    ...
    protected function make_crud(){
        ...
        // set subject
        $crud->set_subject('Shapes');

        // displayed columns on list, edit, and add, uncomment to use
        //$crud->columns('page_id', 'id', 'type', '_scale', 'color', 'posinfo_x_cx', 'posinfo_y_cy', 'posinfo_width_rx', 'posinfo_height_ry', 'labels', 'lines');
        //$crud->edit_fields('page_id', 'id', 'type', '_scale', 'color', 'posinfo_x_cx', 'posinfo_y_cy', 'posinfo_width_rx', 'posinfo_height_ry', 'labels', 'lines', '_updated_by', '_updated_at');
        //$crud->add_fields('page_id', 'id', 'type', '_scale', 'color', 'posinfo_x_cx', 'posinfo_y_cy', 'posinfo_width_rx', 'posinfo_height_ry', 'labels', 'lines', '_created_by', '_created_at');
        //$crud->set_read_fields('page_id', 'id', 'type', '_scale', 'color', 'posinfo_x_cx', 'posinfo_y_cy', 'posinfo_width_rx', 'posinfo_height_ry', 'labels', 'lines');

        // caption of each columns
        $crud->display_as('page_id','page id');
        $crud->display_as('id','json id');
        $crud->display_as('type','Type');
        $crud->display_as('_scale','Scale');
        $crud->display_as('color','Color');
        $crud->display_as('posinfo_x_cx','pos x');
        $crud->display_as('posinfo_y_cy','pos y');
        $crud->display_as('posinfo_width_rx','width/rx');
        $crud->display_as('posinfo_height_ry','height/ry');
        $crud->display_as('labels','labels');
        $crud->display_as('lines','lines');

		$crud->unset_texteditor('labels');
		$crud->unset_texteditor('lines');
        ////////////////////////////////////////////////////////////////////////
        ...
        ////////////////////////////////////////////////////////////////////////
        $crud->field_type('type', 'enum', array('rect','ellipse'));
    ...
    public function index(){
        ...
        // show the view
        $this->view($this->cms_module_path().'/Manage_imbrex_text_shapes_view', $output,
            $this->n('manage_imbrex_text_shapes'), $config);
    }
