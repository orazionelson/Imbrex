...
/**
 * Description of Manage_imbrex_text_labels
 *
 * @author No-CMS Module Generator
 */
class Manage_imbrex_text_labels extends CMS_CRUD_Controller {

    protected $URL_MAP = array();
    protected $TABLE_NAME = 'imbrex_text_labels';
    protected $COLUMN_NAMES = array('series_id', 'id', 'name');
    ...
    protected function make_crud(){
        ...
        //$crud->columns('series_id', 'id', 'name');
        //$crud->edit_fields('series_id', 'id', 'name', '_updated_by', '_updated_at');
        //$crud->add_fields('series_id', 'id', 'name', '_created_by', '_created_at');
        //$crud->set_read_fields('series_id', 'id', 'name');

        // caption of each columns
        $crud->display_as('series_id','Series id');
    ...
    public function index(){
        ...
        // show the view
        $this->view($this->cms_module_path().'/Manage_imbrex_text_labels_view', $output,
            $this->n('manage_imbrex_text_labels'), $config);
    }
