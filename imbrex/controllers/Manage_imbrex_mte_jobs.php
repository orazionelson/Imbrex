...
/**
 * Description of Manage_imbrex_mte_jobs
 *
 * @author No-CMS Module Generator
 */
class Manage_imbrex_mte_jobs extends CMS_CRUD_Controller {

    protected $URL_MAP = array();
    protected $TABLE_NAME = 'imbrex_mte_jobs';
    protected $COLUMN_NAMES = array('ed_id', 'user_id');
    protected $PRIMARY_KEY = 'mte_job_id';
    ...
    protected function make_crud(){
        ...
        // set subject
        $crud->set_subject('Assign edition to Editors');

        // displayed columns on list, edit, and add, uncomment to use
        //$crud->columns('ed_id', 'user_id');
        //$crud->edit_fields('ed_id', 'user_id', '_updated_by', '_updated_at');
        //$crud->add_fields('ed_id', 'user_id', '_created_by', '_created_at');
        //$crud->set_read_fields('ed_id', 'user_id');

        // caption of each columns
        $crud->display_as('ed_id','Edition id');
        $crud->display_as('user_id','Editor');
        ...
        ////////////////////////////////////////////////////////////////////////
        $crud->required_fields('ed_id', 'user_id');
        ...
        ////////////////////////////////////////////////////////////////////////
        $crud->set_relation('ed_id', $this->t('imbrex_filedesc'), 'xml_id');
        $crud->set_relation('user_id', $this->t('main_user'), 'user_name');
    ...
    public function index(){
        ...
        // show the view
        $this->view($this->cms_module_path().'/Manage_imbrex_mte_jobs_view', $output,
            $this->n('manage_imbrex_mte_jobs'), $config);
    }
