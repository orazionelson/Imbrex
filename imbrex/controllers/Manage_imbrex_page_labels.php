...
/**
 * Description of Manage_imbrex_page_labels
 *
 * @author No-CMS Module Generator
 */
class Manage_imbrex_page_labels extends CMS_CRUD_Controller {

    protected $URL_MAP = array();
    protected $TABLE_NAME = 'imbrex_page_labels';
    protected $COLUMN_NAMES = array('page_id', 'id', 'name', 'selections', 'shapes');
    ...
    protected function make_crud(){
        ...
        // set subject
        $crud->set_subject('Page Labels');

        // displayed columns on list, edit, and add, uncomment to use
        //$crud->columns('page_id', 'id', 'name', 'selections', 'shapes');
        //$crud->edit_fields('page_id', 'id', 'name', 'selections', 'shapes', '_updated_by', '_updated_at');
        //$crud->add_fields('page_id', 'id', 'name', 'selections', 'shapes', '_created_by', '_created_at');
        //$crud->set_read_fields('page_id', 'id', 'name', 'selections', 'shapes');
		...
		$crud->unset_texteditor('selections');
		$crud->unset_texteditor('shapes');
        ////////////////////////////////////////////////////////////////////////
    ...
    public function index(){
        ...
        // show the view
        $this->view($this->cms_module_path().'/Manage_imbrex_page_labels_view', $output,
            $this->n('manage_imbrex_page_labels'), $config);
    }
